        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalDetailLabel">Edit Surat Penerimaan</h1>
            ...
            <div class="card-header">
                ...
                <!-- Pemohon 5 -->
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Ttd Digital / QR Code" id="editTtd_digital" name="old_ttd_digital">
