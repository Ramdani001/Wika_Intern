...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 04, 2023 at 08:11 AM
...
(10, 29, 'Menambahkan Features CRUD', 'CRUD', 'Done', '123', NULL, '2023-11-04', '2023-11-04'),
(11, 33, 'Menambahkan Features CRUD Pada CI 3', 'd', 'Pending', NULL, NULL, '2023-11-04', '2023-11-04');
...
CREATE TABLE `penilaian` (
  ...
  `kedisiplinan` int(30) NOT NULL,
  `tanggung_jawab` int(30) NOT NULL,
  `kerapihan` int(30) NOT NULL,
  `komunikasi` int(30) NOT NULL,
  `pemahaman_pekerjaan` int(30) NOT NULL,
  `manajemen_waktu` int(30) NOT NULL,
  `kerjasama_tim` int(30) NOT NULL,
...
(1, 'PU.09.01/WIK.MJK.00341/2023', 33, 3, 3, 3, 3, 3, 3, 3, '2023-11-23');
...
(29, 208866, 'Aroyyan', 'aroy@gmail.com', '089273847323', '$2y$10$ybieB4Bixd6ZtI0BJ.pzj.YayZVgYpkit4ZKNqLUBIWWcuoRaYYdK', 'Cimahi', 'STT Mandala', '', 1, 0, 3, 1, 'default.png', '2023-10-28', '2023-10-30 04:27:14'),
...
(31, 7778383, 'Administrator', 'administrator@gmail.com', '082177777', '$2y$10$QXvaHOXVWvRRxlBb5SlL1OQeHpG6C1Z6e2OCnGjUfYx9He8ZzgAsG', '-', 'Office 1', 'HRD', 4, 0, 1, 1, 'default.png', '2023-10-28', '2023-11-03 11:14:17'),
...
(34, 77777, 'Lelyffff', 'devi@gmail.com', '089273847323', '$2y$10$VPUMrE.iFHEhLnb/Jr67BuVMsRt0WhKo2qCj9mOGMOsiIlJPJvMVO', 'asdfg', 'Office 1', 'HRD', 2, 0, 3, 1, 'default.png', '2023-11-02', '2023-11-02 07:54:12');
...
--
ALTER TABLE `divisi`
  MODIFY `idDivisi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
